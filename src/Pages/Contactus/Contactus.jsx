      ...
      <footer className="footer">
        ...
        <div className="footer-content">
          ...
          <div className="footer-section shop-links">
            ...
            <a href="/#products" onClick={(e) => { e.preventDefault(); window.location.href = '/'; }}>PRODUCTS</a>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <p style={{ margin: 0, color: '#fff', fontSize: '14px' }}>© 2024 Shri Thillai Textiles. All rights reserved.</p>
        </div>
